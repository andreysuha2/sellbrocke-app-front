module.exports = {
  ...
  rules: {
    ...
    "newline-per-chained-call": ["error", { "ignoreChainWithDepth": 3 }], // используется цепочка из более чем 3 методов в одной строке см. https://eslint.org/docs/rules/newline-per-chained-call
